...
HuginnAgent.load 'huginn_dkt_content_curation_agents/concerns/nif_api_agent_concern'
...
HuginnAgent.register 'huginn_dkt_content_curation_agents/dkt_pos_agent'
